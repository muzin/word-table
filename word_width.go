...
//*/
//func bisearch (ucs int, table [][]int) int {
//	lbound := 0
//	ubound := len(table) - 1
//	var mid int
//
...
//}
//
//func charCodeWidth (ucs int) int {
///*
...
//	if bisearch(ucs, ZeroWidth) != 0 {
//		return 0
//	}
//
//	return 1 + bisearch(ucs, WideEastasian)
//}
//
//func ParseWordWidth(str string) int {
//	i := 0
//	len := len(str)
//	sum := 0
//	for ; i < len; i++ {
//		strcode := int(str[i])
//		sum += charCodeWidth(strcode)
//	}
//	return sum
//}